...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ConditionalOffer', fields ['name']
        db.delete_unique('offer_conditionaloffer', ['name'])

        # Removing unique constraint on 'ConditionalOffer', fields ['slug']
        db.delete_unique('offer_conditionaloffer', ['slug'])

        # Adding unique constraint on 'ConditionalOffer', fields ['name', 'site']
        db.create_unique('offer_conditionaloffer', ['name', 'site_id'])

        # Adding unique constraint on 'ConditionalOffer', fields ['slug', 'site']
        db.create_unique('offer_conditionaloffer', ['slug', 'site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ConditionalOffer', fields ['slug', 'site']
        db.delete_unique('offer_conditionaloffer', ['slug', 'site_id'])

        # Removing unique constraint on 'ConditionalOffer', fields ['name', 'site']
        db.delete_unique('offer_conditionaloffer', ['name', 'site_id'])

        # Adding unique constraint on 'ConditionalOffer', fields ['slug']
        db.create_unique('offer_conditionaloffer', ['slug'])

        # Adding unique constraint on 'ConditionalOffer', fields ['name']
        db.create_unique('offer_conditionaloffer', ['name'])
    ...
    models = {
        ...
        'catalogue.category': {
            ...
            'exclude_from_product_view': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'catalogue.product': {
            ...
            'bestseller_weight': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['catalogue.Category']", 'through': "orm['catalogue.ProductCategory']", 'symmetrical': 'False'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'home_order': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_discountable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'isbn': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'variants'", 'null': 'True', 'to': "orm['catalogue.Product']"}),
            'performance_rating': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'product_class': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.ProductClass']", 'null': 'True'}),
            'product_options': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['catalogue.Option']", 'symmetrical': 'False', 'blank': 'True'}),
            'rating': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'rating_weight': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'story_rating': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
        ...
        'catalogue.productclass': {
            ...
            'commercial_weight': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'extend_loan_by': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'offer.conditionaloffer': {
            'Meta': {'ordering': "['-priority']", 'unique_together': "(('name', 'site'), ('slug', 'site'))", 'object_name': 'ConditionalOffer'},
        ...
        'offer.range': {
            'Meta': {'unique_together': "(['name', 'site'],)", 'object_name': 'Range'},
