...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Range', fields ['name']
        db.delete_unique('offer_range', ['name'])

        # Adding unique constraint on 'Range', fields ['name', 'site']
        db.create_unique('offer_range', ['name', 'site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Range', fields ['name', 'site']
        db.delete_unique('offer_range', ['name', 'site_id'])

        # Adding unique constraint on 'Range', fields ['name']
        db.create_unique('offer_range', ['name'])
