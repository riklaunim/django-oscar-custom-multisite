...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConditionalOffer.site'
        db.add_column('offer_conditionaloffer', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConditionalOffer.site'
        db.delete_column('offer_conditionaloffer', 'site_id')
